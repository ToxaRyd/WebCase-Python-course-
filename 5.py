...
def print_users(users):
    ...
    a1 = " {0:<{nw}.17} {1:^6} {2:{uw}} ".format("Name", "ID", "Username", nw=namewidth, uw=usernamewidth)
    a2 = "{0:-<{nw}} {0:-<6} {0:-<{uw}} ".format("", nw=namewidth, uw=usernamewidth)
    z1 = []
    c = 0
    for key in sorted(users):
        ...
        z1.append("{0:.<{nw}} ({1.id:4}) {1.username:{uw}}".format(
